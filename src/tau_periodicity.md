...
- `use_positive_taus=False`: Points are returned as generated by the backend (in $(-\beta/2, \beta/2]$, symmetric about $0$)

### Rust: $(-\beta/2, \beta/2]$ range

The Rust backend (`sparse-ir-rs`) natively generates sampling points in the interval $(-\beta/2, \beta/2]$, symmetric about $0$.
